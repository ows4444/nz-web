...
export const lightTheme = new Theme()
  ...
  .addBorderRadius('pill', '50px')
  .addBorderRadius('circle', '50%')
  .addBorderRadius('none', '0')
  .addBorderRadius('xxs', '2px')
  .addBorderRadius('xs', '4px')
  .addBorderRadius('sm', '8px')
  .addBorderRadius('md', '16px')
  .addBorderRadius('lg', '24px')
  .addBorderRadius('xl', '32px')
  .addBorderRadius('xxl', '48px')

  .addMarginPadding('xxl', '64px')
  .addMarginPadding('xl', '32px')
  .addMarginPadding('lg', '16px')
  .addMarginPadding('md', '8px')
  .addMarginPadding('sm', '4px')
  .addMarginPadding('xs', '2px')
  .addMarginPadding('xxs', '1px');
